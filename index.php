...
<html lang="en">
    ...
    <body>
            ...
            <div class="row gx-0 align-items-center" style="height: 45px;">
                <div class="col-lg-8 text-center text-lg-start mb-lg-0">
                    <div class="d-flex flex-wrap">
                        ...
                        <a href="dashboard/index.php" class="text-light me-4"><i class="fas fa-phone-alt text-primary me-2"></i>+89(0)2354 5470091</a>
                    ...
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="klien.php" class="dropdown-item">Our Client</a>
        ...
        <div class="hero">
            ...
            <img src="img/team.jpg" class="person" alt="Person Image">
            
            <!-- SVG untuk efek lengkungan -->
            <div class="wave-container">
                <svg viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
                    <path fill="white" fill-opacity="1" 
                        d="M0,192L60,192C120,192,240,192,360,208C480,224,600,256,720,240C840,224,960,160,1080,128C1200,96,1320,96,1380,96L1440,96L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z">
                    </path>
                </svg>
            </div>
        </div>
        ...
        <div class="container-fluid py-5 client-reviews-section">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="text-center"><a href="klien.php"> Kerjasama</a></h2>
                <div class="client-reviews owl-carousel owl-theme">
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo '    <div class="reviewer media mt-3">';
                            echo '        <div class="reviewer-meta media-body align-self-center ml-4">';
                            echo '            <h5 class="reviewer-name color-primary mb-2">' . $row["client_name"] . '</h5>';
                            echo '        </div>';
                            echo '        <div class="reviewer-thumb">';
                            echo '            <img class="avatar-lg radius-200" src="img/' . $row["client_image"] . '" alt="img">';
                            echo '        </div>';
                            echo '    </div>';
                            echo '</div>';
                        }
                ...
                <div class="row g-4 justify-content-center">
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo '            <img src="img/' . $row["service_image"] . '" class="img-fluid rounded-top w-100" alt="">';
                            echo '        </div>';
                            echo '        <div class="service-content rounded-bottom bg-light p-4">';
                            echo '            <div class="service-content-inner">';
                            echo '                <h5 class="mb-4">' . $row["service_name"] . '</h5>';
                            echo '                <p class="mb-4">' . $row["service_description"] . '</p>';
                            echo '                <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">Read More</a>';
                            echo '            </div>';
                            echo '        </div>';
                            echo '    </div>';
                            echo '</div>';
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-5 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-img pb-5 ps-5">
                            <img src="img/1.png" class="img-fluid rounded w-100" style="object-fit: cover;" alt="Image">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-6">
                                    <div class="video h-100">
                                        <img src="img/team.jpg" class="img-fluid rounded w-100 h-100" style="object-fit: cover;" alt="">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item rounded">
                            <div class="team-img rounded-top h-100">
                                <img src="img/team.jpg" class="img-fluid rounded-top w-100" alt="">
                                <div class="team-icon d-flex justify-content-center">
                                    ...
                                    <a class="btn btn-square btn-primary text-white rounded-circle mx-1" href=""><i class="fab fa-whatsapp"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-inner p-5">
                            <div class="testimonial-inner-img mb-4">
                                <img src="img/testimoni.png" class="img-fluid rounded-circle" alt="">
                            </div>
