...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        // Ensure 'edit' parameter exists in the URL
        ...
        if (isset($_POST['publise'])) {
            ...
            if ($edit == '') {
                ...
                $insertdata = mysqli_query($con, "INSERT INTO testimonials (title, designation, descrip, img, date, status) VALUES ('$title', '$designation', '$comments', '$lis_img', '$today', '0')");
                if ($insertdata) {
                    echo "<script>alert('Posted Successfully');</script>
                          <script>window.location.href = 'add-testimonials.php'</script>";
                } else {
                    echo "<script>alert('Error while posting the testimonial.');</script>";
                }
            } else {
                // Update existing testimonial
                $insertdata = mysqli_query($con, "UPDATE testimonials SET title = '$title', designation = '$designation', descrip = '$comments', img = '$lis_img', date = '$today' WHERE id = '$edit'");
                if ($insertdata) {
                    echo "<script>alert('Updated Successfully');</script>
                          <script>window.location.href = 'add-testimonials.php'</script>";
                } else {
                    echo "<script>alert('Error while updating the testimonial.');</script>";
                }
            }
        }
