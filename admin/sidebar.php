      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item has-treeview menu-open">
          ...
          <li class="nav-item has-treeview menu-open">
            <h5 class="pt-2 pb-2" style="color:white;">Partnership</h5>
          <li class="nav-item has-treeview menu-open">
            <a href="add-partner.php" class="nav-link">
               <i class="fa fa-plus nav-icon"></i>
              <p>
                Add Partnership
              </p>
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="view-partner.php" class="nav-link">
               <i class="fa fa-eye nav-icon"></i>
              <p>
                View Partnership
              </p>
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="add-gallery.php" class="nav-link">
               <i class="fa fa-plus nav-icon"></i>
              <p>
                Add Gallery
              </p>
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="view-gallery.php" class="nav-link">
               <i class="fa fa-eye nav-icon"></i>
              <p>
                View Gallery
              </p>
