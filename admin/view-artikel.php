...
if (isset($_GET['delete_id'])) {
    ...
    $query_delete = "DELETE FROM articles WHERE id='$delete_id'";
    $p = mysqli_query($con, $query_delete);
    if ($p) {
        $_SESSION['msg'] = "Berhasil Dihapus";
        $_SESSION['msgClass'] = "success";
    } else {
        $_SESSION['msg'] = "Terjadi kesalahan saat menghapus artikel.";
        $_SESSION['msgClass'] = "danger";
    }
    header("Location: view-artikel.php");
    exit;
}
?>
<!DOCTYPE html>
...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6" style="text-align:right;">
                            <a class="btn btn-primary" href="add-artikel.php">
    ...
    <script>
        ...
        let table = new DataTable('#myTable', {
            ...
            processing: true,
            ajax: {
                url: 'ajax.php?action=fetch_articles',
                type: 'GET',
            ...
            columns: [
                { 
                    ...
                    render: function(data) {
                        return data ? '<img src="images/artikel/' + data + '" style="width: 100px; height: auto;">' : '<span class="text-muted">Tidak ada gambar</span>';
                    }
                },
                { data: 'title' },
                { 
