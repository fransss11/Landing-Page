...
if (isset($_GET['delete_id'])) {
    ...
    $query_delete = "DELETE FROM service_categories WHERE id='$delete_id'";
    $p = mysqli_query($con, $query_delete);
    if ($p) {
        $_SESSION['msg'] = "Berhasil Dihapus";
        $_SESSION['msgClass'] = "success";
    } else {
        $_SESSION['msg'] = "Terjadi kesalahan saat menghapus sub-layanan.";
        $_SESSION['msgClass'] = "danger";
    }
    header("Location: view-sub_layanan.php");
    exit;
}
?>
<!DOCTYPE html>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Semua Sub-Layanan</h1>
                        </div>
                        <div class="col-sm-6" style="text-align:right;">
                            <a class="btn btn-primary" href="add-sub_layanan.php">
    ...
    <script>
        ...
        let table = new DataTable('#myTable', {
            ...
            processing: true,
            ajax: {
                url: 'ajax.php?action=fetch_service_categories',
                type: 'GET',
