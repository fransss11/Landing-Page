        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle <?php echo in_array(getCurrentPage(), ['klien.php','team.php','projek.php','testimoni.php','artikel.php']) ? 'active' : ''; ?>" data-bs-toggle="dropdown">Informasi</a>
